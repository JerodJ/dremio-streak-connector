...
@SourceType(value = "StreakARP", label = "Streak",uiConfig = "streak-layout.json")
public class StreakConf extends AbstractArpConf<StreakConf> {
  private static final String ARP_FILENAME = "arp/implementation/streak-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.streak.StreakDriver";
